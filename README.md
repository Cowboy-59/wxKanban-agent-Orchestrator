...
- `v0.1.9` — fix Windows blockers from BUG_REPORT v0.1.8: don't ship Linux-only `node_modules`, fix `bin/wxkanban-agent.cmd` Node version detection, remove crashing `wxkanban-agent` postinstall hook
