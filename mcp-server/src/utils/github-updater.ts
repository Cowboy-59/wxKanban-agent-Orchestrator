 ...
 * 
 * Checks for MCP server updates from GitHub releases and handles installation.
 * Part of 017 MCP Project Hub - Auto-update feature
 */
...
const MCP_SERVER_PATH = resolve(__dirname, '../..');
const PACKAGE_JSON_PATH = join(MCP_SERVER_PATH, 'package.json');

// GitHub repository configuration
const GITHUB_OWNER = 'wxperts';
const GITHUB_REPO = 'wxKanban';
const GITHUB_API_BASE = `https://api.github.com/repos/${GITHUB_OWNER}/${GITHUB_REPO}`;

// Update check configuration
const UPDATE_CHECK_INTERVAL_HOURS = 24; // Check once per day
...
/**
 * Get current MCP server version from package.json
 */
